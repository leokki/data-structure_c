...
int main(void) {
    ...
    InsertAvltree(&root, 10);
    InsertAvltree(&root, 2);
    InsertAvltree(&root, 6);
    InsertAvltree(&root, 8);
    InsertAvltree(&root, 23);
    InsertAvltree(&root, 13);
    InsertAvltree(&root, 18);
    InsertAvltree(&root, 3);
    InsertAvltree(&root, 11);
    InsertAvltree(&root, 14);
    InsertAvltree(&root, 9);
    ...
    DeleteAvltree(&root, 2);
    DeleteAvltree(&root, 8);
