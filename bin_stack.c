...
void InitStack(BinStack* pStack, size_t dataSize) {
...
static struct Node* CreateNode(BinStack* pStack, void* pData) {
...
bool IsStackEmpty(BinStack* pStack) {
...
bool PushIntoTop(BinStack* pStack, void* pData) {
...
bool PushIntoMidst(BinStack* pStack, void* pData, int order) {
...
bool PushIntoBase(BinStack* pStack, void* pData) {
    struct Node* p = CreateNode(pStack, pData);
    if (p == NULL) {
        return false;
    }
...
bool GetFromTop(BinStack* pStack, void* pReception) {
...
bool GetFromMidst(BinStack* pStack, void* pReception, int order) {
...
bool GetFromBase(BinStack* pStack, void* pReception) {
    if (IsStackEmpty(pStack) == true) {
        return false;
    }
    char* p = (char*)pReception;
...
bool PopFromTop(BinStack* pStack, void* pReception) {
    if (IsStackEmpty(pStack) == true){
        return false;
    }
    char* p = (char*)pReception;
...
bool PopFromMidst(BinStack* pStack, void* pReception, int order) {
    if (IsStackEmpty(pStack) == true || order <= 0 || order > pStack->length) {
        return false;
    }
    struct Node* cur = pStack->pTopNode;
...
bool PopFromBase(BinStack* pStack, void* pReception) {
    if (IsStackEmpty(pStack) == true){
        return false;
    }
    char* p = (char*)pReception;
...
bool ReverseStack(BinStack* pStack) {
    if (IsStackEmpty(pStack) == true) {
        return false;
    }
...
void DestroyStack(BinStack* pStack) {
    struct Node* p;
...
int LengthOfStack(BinStack* pStack) {
